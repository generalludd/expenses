...
<div class="search-block">
	<form name="search-accounts" id="search-accounts"
		...
		<div class="stacked-fields">
			...
			<?php endif; ?>
			<?php $selectors['select'] = [
					'text' => 'Select All',
					'href' => '#',
					'title' => 'Select all accounts',
					'class' => 'link select-accounts',
			];
			$selectors['select-none'] = [
					'text' => 'Reset',
				'href'=>'#',
				'title'=>'Reset all',
				'class'=>'link reset-accounts',
					];?>
			<?php print create_button_bar($selectors); ?>
			<?php echo form_multiselect('account_ids[]', $accounts, $this->input->get('account_ids'), ['class' => 'chosen-select account-selector']); ?>
		</div>
		<div class="inline-fields">
