...
$nav_buttons["show_month"] = array("item" => "expense", "text" => "Select Month", "type"=>"span","class" => "btn btn-sm btn-primary select-month");
 if($this->session->userdata("role") == "admin" ){
$nav_buttons["create_expense"] = array("item" => "expense", "text" => "New Expense", "type" =>"span", "class" => "btn btn-sm btn-warning new expense create", "id"=>sprintf("ec_%s",$this->session->userdata("userID")));
...
$user_buttons["user_list"] = array("item" => "user", "text" => "User List", "href" => site_url("user/show_all"), "class" => "btn btn-sm btn-primary show-user-list");
 ...
 $user_buttons["preferences"] = array("item" => "preference", "text"=> "Preferences", "title"=>"Change Your Settings", "href"=>site_url("preference/view/" . $this->session->userdata("userID")),"class"=>"btn btn-sm btn-primary show-preferences");
 $user_buttons["feedback"] = array("item" => "preference","text"=>"Feedback","class"=>"btn btn-sm btn-primary create_feedback create-feedback","title"=>"Send Feedback for Improvements or Problems");
