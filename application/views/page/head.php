...
<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url("css/color.css")?>" />
<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url("css/popup.css")?>" />
<link type="text/css" rel="stylesheet"  media="(max-width: 855px)" href="<?php echo base_url("css/mobile.css")?>" />
...
<!-- <script type="text/javascript" src="<?php echo base_url("js/forms.jquery.js");?>"></script>  
<script type="text/javascript" src="<?php echo base_url("js/cookie.jquery.js");?>"></script> -->
