...
<div id="monthly-fees" class='block border'>
    ...
    <p><a class="btn btn-warning btn-sm dialog edit" href="<?php echo site_url("fee/create");?>">New Fee</a></p>
    <table class="list table"><thead><tr>
        ...
        <?php
        foreach($fees as $fee):?>
            <tr><td><a class='btn btn-secondary btn-sm edit dialog' href='<?php echo site_url("fee/edit/$fee->id");?>'>Edit</a></td>
            <td><?php echo $fee->type; ?></td><td class='amt'><?php echo get_as_cash($fee->amt); ?> </td>
            <td class='amt'><?php echo get_as_cash($fee->amt/$user_count);?> </td><tr>
