...
<div id="monthly-fees" class='block border'>
    ...
    <table class="list table">
        ...
        <tr data-id="<?php echo $fee->id;?>">
			...
			<td>
			<a href="<?php echo base_url("fee/delete");?>" data-id="<?php echo $fee->id;?>" data-parent="tr" class="button btn-sm btn btn-danger delete ajax" title="Delete this fee"><i class="far fa-trash-alt"></i></a>
			</td>
		<tr>
