...
if($payment != NULL): ?>
	<tr>
	<td>Amount Paid</td>
	<td class="amt"><a href='<?php echo base_url("/payment/edit/?id=$payment->id");?>' class='edit dialog payment-edit' id='pmt_<?php echo $payment->id . "_" . $grand_total;?>'>-<?php echo get_as_cash($payment->amt);?></a> </td>
	</tr>
